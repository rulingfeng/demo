 ...
 * 
 */
public class RedisBitSet extends AdvanceBitSet {
	private Jedis jedis;
	private String name;
	private int size;
	 ...
	 */
	public AdvanceBitSet asBitSet() {
		return AdvanceBitSet.valueOf(toByteArray());
	}
	 ...
	 */
	public void overwrite(Jedis connection, AdvanceBitSet bitSet) {
